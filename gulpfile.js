/*!
 * bower (instalar utilizando o terminal bash do git)
 * bower install jquery#1.11.1 jquery-validation jquery-validation-unobtrusive modernizr bootstrap respond-minmax jquery-scrollto jquery.localScroll --save
 *
 * gulp
 $ npm install gulp jshint gulp-jshint gulp-compass gulp-concat gulp-changed gulp-uglify gulp-rename gulp-autoprefixer es6-promise gulp-promise gulp-notify gulp-livereload gulp-clean gulp-cssnano gulp-copy gulp-bower gulp-sourcemaps  gulp-imagemin gulp-image-optimization --save-dev
 */
